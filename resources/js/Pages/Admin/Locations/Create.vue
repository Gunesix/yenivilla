<template>
  <AdminLayout :breadcrumbs="breadcrumbs">
    <div class="max-w-4xl mx-auto space-y-6">
      <!-- Header -->
      <div>
        <h1 class="text-2xl font-bold text-gray-900">Yeni Lokasyon Oluştur</h1>
        <p class="text-gray-600">Villa lokasyonu bilgilerini girin</p>
      </div>
        ...
        <form @submit.prevent="submitForm" class="p-6 space-y-6">
          ...
          <div>
            ...
            <p class="text-gray-500 text-sm mt-1">
              URL'de görünecek kısa ad (otomatik oluşturulur)
            </p>
          ...
          <div>
            ...
            <div class="flex items-center space-x-4">
              ...
              <div v-if="imagePreview" class="flex-shrink-0">
                <img :src="imagePreview" alt="Önizleme" class="h-20 w-32 object-cover border border-gray-300 rounded">
              </div>
          ...
          <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
            ...
            >
              ...
              <span v-else>Lokasyon Oluştur</span>
            </button>
          </div>
        </form>
      </div>
